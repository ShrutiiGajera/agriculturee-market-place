...
import t01 from './images/t1.jpg'
import t02 from './images/t02.png'
    ...
    return (
        <>
                ...
                <div className="card mb-3">
                    <div className="row g-0">
                        <div className="col-md-4">
                            <img src={t01} className="t" alt="images" />
                            {/* <img src={t02} className="tt" alt="images" /> */}
                        </div>
                        <div className="col-md-8">
                            <div className="card-body">
                                <p className="get">Get to Know Us</p>
                                <h5 className="card-titleee">The Best Agriculture Market</h5>
                                <p className="there">There are many variations of passa of lorem available, but the majority have suffered alteration.</p>
                                ...
                                <p className="are">There are many variations of passages of lorem ipsum available but the
                                    ...
                                    andom word which don’t look even.</p> <br /><br /><br /><br /><br /><br />
                                <h4><img src={Frame} className="icon" alt="image" />Language Translator</h4>
                                <h4><img src={Frame} className="icon" alt="image" />Online Transactions</h4>
                                <h4><img src={Frame} className="icon" alt="image" />Two-step verification</h4>
            ...
            <div>
                ...
                <p className="meet">Meet Our Farmers</p>
                <div className="explor">
                    <div className="row" id="row">
                        <div className="col-md-4">
                            <img src={d1} className='d' alt='img' />
                        </div>
                        <div className="col-md-4">
                            <img src={d2} className='d' alt='img' />
                        </div>
                        <div className="col-md-4">
                            <img src={d3} className='d' alt='img' />
                        </div>
